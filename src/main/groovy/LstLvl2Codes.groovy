/**
 * EXT001MI.LstLvl2Codes
 * Extension API to list the level 2 reason codes stored in CUGEX1
 * Date	    Changed By  Description
 */
public class LstLvl2Codes extends ExtendM3Transaction {
  private final MIAPI mi;
  private final DatabaseAPI database;
  private final ProgramAPI program;

  public LstLvl2Codes(MIAPI mi, DatabaseAPI database, ProgramAPI program) {
    this.mi = mi;
  ...
  public void main() {
    ...
    queryCUGEX1.readAll(containerCUGEX1, 4, handler)
  }
