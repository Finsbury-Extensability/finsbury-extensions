...
public class LstPickersPL extends ExtendM3Transaction {
  ...
  public void main() {
    ...
    def params = [ "WHLO": mi.inData.get("WHLO").trim(),
                   "FPIS": mi.inData.get("ZFPI").trim(),
                   "TPIS": mi.inData.get("ZTPI").trim(),
                   "FORC": mi.inData.get("ZFOR").trim(),
                   "TORC": mi.inData.get("ZTOR").trim(),
                   "FSEQ": mi.inData.get("ZFSE").trim(),
                   "TSEQ": mi.inData.get("ZTSE").trim(),
                   "SSEQ": mi.inData.get("ZSSE").trim(),
                   "ZFTP": mi.inData.get("ZFTP").trim(),
                   "ZTTP": mi.inData.get("ZTTP").trim(),
                   "ZLST": mi.inData.get("ZLST").trim(),
                   "TEAM": mi.inData.get("TEAM").trim(),
                   "PICK": mi.inData.get("PICK").trim(),
                   "DLIX": mi.inData.get("DLIX").trim(),
                   "PLSX": mi.inData.get("PLSX").trim(),
                   "PISE": mi.inData.get("PISE").trim(),
                   "ZXPN": mi.inData.get("ZXPN").trim(),
                   "ZXPL": mi.inData.get("ZXPL").trim(),
                   "ROUT": mi.inData.get("ROUT").trim(),
                   "RODN": mi.inData.get("RODN").trim(),
                   "CONN": mi.inData.get("CONN").trim(),
                   "PLRI": mi.inData.get("PLRI").trim(),
                   "FDDT": mi.inData.get("ZFDD").trim(),
                   "FDHM": mi.inData.get("ZFDH").trim(),
                   "TDDT": mi.inData.get("ZTDD").trim(),
                   "TDHM": mi.inData.get("ZTDH").trim(),
                   "CONA": mi.inData.get("CONA").trim(),
                   "FPAS": mi.inData.get("ZFPA").trim(),
                   "TPAS": mi.inData.get("ZTPA").trim(),
                   "ZPIS": mi.inData.get("ZPIS").trim(),
                   "ZORC": mi.inData.get("ZORC").trim(),
                   "ZPAS": mi.inData.get("ZPAS").trim(),
                   "ZISE": mi.inData.get("ZISE").trim(),
                   "CLPI": mi.inData.get("ZCPI").trim(),
                   "CLPA": mi.inData.get("ZCPA").trim(),
                   "CWV1": mi.inData.get("ZCW1").trim(),
                   "CWV2": mi.inData.get("ZCW2").trim(),
                   "XPI0": mi.inData.get("ZPI0").trim(),
                   "XPA0": mi.inData.get("ZPA0").trim(),
                   "FLPI": mi.inData.get("ZFLI").trim(),
                   "TLPI": mi.inData.get("ZTLI").trim(),
                   "FWPI": mi.inData.get("ZFWI").trim(),
                   "TWPI": mi.inData.get("ZTWI").trim(),
                   "FVPI": mi.inData.get("ZFVI").trim(),
                   "TVPI": mi.inData.get("ZTVI").trim(),
                   "FLPA": mi.inData.get("ZFLA").trim(),
                   "TLPA": mi.inData.get("ZTLA").trim(),
                   "FWPA": mi.inData.get("ZFWA").trim(),
                   "TWPA": mi.inData.get("ZTWA").trim(),
                   "FVPA": mi.inData.get("ZFVA").trim(),
                   "TVPA": mi.inData.get("ZTVA").trim(),
                   "MLPI": mi.inData.get("ZMLI").trim(),
                   "MLPA": mi.inData.get("ZMLA").trim(),
                   "RIDN": mi.inData.get("RIDN").trim()
    ];
    //.error("${params}");
